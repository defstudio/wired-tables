    ...
    <div class="sm:tw-flex" x-data=>
        <div class="tw-relative">
            ...
            <input wire:key="wt-{{$this->id}}-search"
                   ...
                   type="text"
                   placeholder="search..."
                   class="tw-border-gray-300 focus:tw-border-indigo-300 focus:tw-ring focus:tw-ring-indigo-200 focus:tw-ring-opacity-50 tw-rounded-md tw-shadow-sm tw-text-sm tw-placeholder:text-slate-400 tw-text-gray-800 tw-px-7 tw-py-2"
